                        ...
                        >
                          ...
                          render = {({field}) => (
                            <FormItem>
                              ...
                              <div className="font-style-7-hint font-jakarta opacity-70">This is the title, write your question here.</div>
                              <FormMessage/>
                            </FormItem>
                          )}
                          />
                          ...
                          <FormField
                            ...
                            render = {({field}) => (
                              <FormItem>
                                ...
                                <div className="font-style-7-hint font-jakarta opacity-70">This is the description, give more details about your question here.</div>
                                <FormMessage/>
                              </FormItem>
                            )}
                          />
    ...
    <div className="flex">
                            ...
                            {selectedMainCategory && (
                              <Select value={""} onValueChange={handleSubcategoryChange}>
                                <SelectTrigger>
                                <SelectValue className="normal-case" placeholder={`Select sub-category for ${selectedMainCategory.split("|").join("/")}`} />
                                </SelectTrigger>
                                <SelectContent>
                                  <SelectGroup>
                            ...
                            <div className="font-style-7-hint font-jakarta opacity-70 mt-2">This is the category, you can choose multiple categories for your Question.</div>
                          </div>
          ...
          <div>
            ...
            <SelectItem value={"poll"}>Poll</SelectItem>
              ...
              <><div>
                ...
                <div className="font-style-7-hint font-jakarta opacity-70 mt-2">
                ...
                <div />
                          ...
                          />
                              ...
                              <Button type="submit" 
                                className="font-style-4 font-dmsans  font-style-4 font-dmsans  w-full"
