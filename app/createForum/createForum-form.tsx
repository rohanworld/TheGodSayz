                        ...
                        >
                          ...
                          render = {({field}) => (
                            <FormItem>
                              ...
                              <div className="font-style-7-hint font-jakarta opacity-70">This is for forum url, Give a Unique Forum Name here</div>
                              <FormMessage/>
                            </FormItem>
                          )}
                          />
                          ...
                          render = {({field}) => (
                            <FormItem>
                              ...
                              <div className="font-style-7-hint font-jakarta opacity-70">This name will be visible to the users, Give a Forum Name here</div>
                              <FormMessage/>
                            </FormItem>
                          )}
                          />
                          ...
                          render = {({field}) => (
                            <FormItem>
                              ...
                              <div className="font-style-7-hint font-jakarta opacity-70">Upload a logo for your Forum here.</div>
                              <FormMessage/>
                            </FormItem>
                          )}
                          ...
                          <FormField
                            ...
                            render = {({field}) => (
                              <FormItem>
                                ...
                                <div className="font-style-7-hint font-jakarta opacity-70">Give a description and set banner of your forum from here.</div>
                                <FormMessage/>
                              </FormItem>
                            )}
                          />
    ...
    <div className="flex">
                          ...
                          render = {({field}) => (
                            <FormItem>
                              ...
                              <div className="font-style-7-hint font-jakarta opacity-70">Here you can write some Rules for the forum</div>
                              <FormMessage/>
                            </FormItem>
                          )}
                          />
                              ...
                              <Button type="submit" 
                                className="font-style-4 font-dmsans "
