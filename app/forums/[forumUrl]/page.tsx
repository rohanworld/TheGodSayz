    ...
    <div>
        ...
        <div className="mx-auto flex">
          ...
          <div className="flex items-center justify-between mr-2">
            ...
            <div className="ml-[23rem] mb-[7px]">
            {
              ...
              <Button
              className="font-style-4 font-dmsans  focus:outline-none rounded-3xl w-full py-2 px-3 bg-black text-white font-bold border border-gray-600"
              onClick={()=>{
                toast({
            ...
            {joined ? (
              <Link href={`/createForumPost`}>
                <Button className="font-style-4 font-dmsans  focus:outline-none rounded-3xl w-full py-2 px-3 bg-[#373737] text-white font-bold border border-gray-600">
                  CREATE POST
                </Button>
              </Link>
            ) : (
              <Button
                onClick={joinInForum}
                className="font-style-4 font-dmsans  focus:outline-none rounded-3xl w-full py-2 px-3 bg-[#373737] text-white font-bold border border-gray-600"
              >
                Join Forum First
              </Button>
            )}
          ...
          <div>
            {
              joined&&
              <Button
              className="font-style-4 font-dmsans  ml-5 text-sm text-[16px] text-black font-semibold border hover:bg-slate-300 border-gray-600 bg-slate-200 py-0 md:px-3 rounded-3xl focus:outline-none"
              onClick={joinInForum}
            >
            Exit Forum
            </Button>
      ...
      <div className="bg-section md:flex container mx-auto py-[11px] px-0 md:items-start items-center justify-center md:space-x-[2rem] md:mt-[4rem]">
        ...
        <div className="bg-card bg-[#ffffff] dark:bg-[#262626] md:mt-[7px] flex-col space-y-4 md:mr-4 p-4 rounded-lg border-0">
            <p className="font-style-0 font-jakarta  text-2xl ">{forumDetails.numOfPosts || 0} Posts</p>
            <p className="font-style-1-descriptions font-jakarta ">Join the conversation and share your thoughts. Find insights from professionals.</p>
          </div>
          ...
          <div className="bg-section bg-[#ffffff] mt-[7px] md:mr-4 rounded-lg border-0">
            ...
            >
              <div className="space-y-4 py-4">
                ...
                <p className="font-style-0 font-jakarta">{forumDetails.noOfMembers} Members</p>
                <p className="font-style-1-descriptions font-jakarta  mt-2">Many members are interested in this forum and looking for opportunities</p>
                </div>
