    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-7 gap-y-4 md:gap-x-4 pb-6 font-dmsans mt-3">
      ...
      <div className={`${ansLoading?"overflow-auto":""} max-h-screen`}>
        ...
        <div className=" mt-3">
          {isCommentBoxOpen ? (
            <div
              className="font-style-7 rounded-3xl border border-gray-300 p-4 cursor-pointer mx-2 md:mx-0 my-6"
              onClick={user?.isAnonymous?()=>{
                toast({
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormLabel>Description</FormLabel>
                                <div className={`${isFocused?"border-black font-style-3 font-jakarta  border-[2.3px]": "border-[2px] border-[#d3d7dd]"} rounded-lg`} onFocus={() => setIsFocused(true)}
      ...
      <div className="bg-section sm:block hidden col-span-2 sticky overflow-hidden h-fit order-last mt-1">
      <div>
        <RecentFeed />
      </div>
