        ...
        {comments.map((comment, index) => (
          ...
          >
            <div className="flex  space-x-2">
              ...
              />
              <div>
                <p className="font-style-5-username font-dmsans  text-sm font-semibold">{comment.name}</p>
                <p className="font-style-4 font-dmsans  text-sm">{comment.comment}</p>
                <div>
                  <button
                  ...
                  {replyIndex === index && (
                    <div>
                        <div className="flex gap-2">
                          ...
                          />
                          <button
                            className="font-style-4 font-dmsans  rounded-3xl border border-gray-300 p-2 mt-2"
                        ...
                        {comment.replies && comment.replies.sort((a:any, b:any) => b.createdAt - a.createdAt).map((reply, replyIndex) => (
                          <div key={replyIndex} className="flex space-x-2 mt-2 ml-2">
                            ...
                            />
                            <div>
                              <p className="text-sm font-style-5 username font-semibold">{reply.name}</p>
                              <p className="font-style-4 font-dmsans  text-sm">{reply.reply}</p>
                            </div>
                          </div>
                        ))}
                    </div>
