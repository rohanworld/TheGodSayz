      ...
      {dispAnswer.length>0&&dispAnswer.map((answer: any, key) => (
        ...
        >
          <div className="px-6 py-5 flex justify-between">
            ...
            <div className="w-0 flex-1">
              ...
              <div className=" flex space-x-1 mr-5">
                ...
                {/* {formatTimeToNow(new Date(post.createdAt))} */}
                  ...
                  <div className="font-style-4 font-dmsans  mt-[11px]">{answer?.createdAt?.toDate()?.toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}</div>
              </div>
            ...
            <p className="ProseMirror font-style-3 font-jakarta ">{answer.description ? parse(answer.description) : ""}</p>
          ...
          <div className=" dark:bg-[#1A1A1B]/65 z-20 flex justify-between gap-x-3 text-sm px-4 py-4 sm:px-6">
            ...
            <div className=" flex gap-x-3">
              ...
              <button
                className="w-fit flex items-center gap-2"
              >
                <Bookmark className="font-style-4 font-dmsans  h-4 w-4" /> <span className=' sm:block hidden'>Save</span>
              </button>
            </div>
          </div>
