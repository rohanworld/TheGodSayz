    ...
    <tbody>
      ...
      <tr>
        ...
        <Card x-chunk="dashboard-01-chunk-5">
          ...
          <p className="font-style-5-username font-dmsans  font-medium leading-none">{userData.name?userData.name:"Guest"}</p>
            <p className="font-style-5-username font-dmsans  text-muted-foreground">{userData.email?userData.email:"na"}</p>
          </div>
        ...
        <div className='mt-3 lg:hidden col-span-2 sticky overflow-hidden h-fit rounded-2xl shadow-[0px_0px_0px_1px_rgba(8,112,184,0.06),0px_1px_1px_-0.5px_rgba(8,112,184,0.06),0px_3px_3px_-1.5px_rgba(8,112,184,0.06),_0px_6px_6px_-3px_rgba(8,112,184,0.06),0px_12px_12px_-6px_rgba(8,112,184,0.06),0px_24px_24px_-12px_rgba(8,112,184,0.06)]'>
          <Card x-chunk="dashboard-01-chunk-5">
              <CardHeader className='text-sm pb-1'>
                ...
                <div className='font-style-5-username font-dmsans  text-xs text-muted-foreground'>Verify the third-party sites before entering data.</div>
              </CardHeader>
              <CardContent className="">
                <p className='font-style-1-subtitle'>Register for this event on a single click</p>
                <div className=' flex items-end justify-end mt-4'>
                  <Button className='font-style-4 font-dmsans  w-full'><a target='_blabk' href="#">Register now</a></Button>
                </div>
              </CardContent>
          </Card>
        </div>
        ...
        <div className='mt-3 lg:hidden col-span-2 sticky overflow-hidden h-fit rounded-2xl border border-gray-300 shadow-[0px_0px_0px_1px_rgba(8,112,184,0.06),0px_1px_1px_-0.5px_rgba(8,112,184,0.06),0px_3px_3px_-1.5px_rgba(8,112,184,0.06),_0px_6px_6px_-3px_rgba(8,112,184,0.06),0px_12px_12px_-6px_rgba(8,112,184,0.06),0px_24px_24px_-12px_rgba(8,112,184,0.06)]'>
          <Card x-chunk="dashboard-01-chunk-5">
              ...
              <CardContent className="">
                <h1 className='font-style-1-descriptions font-jakarta  flex items-center justify-center mx-auto'>
                  {
        ...
        <Card x-chunk="dashboard-01-chunk-5">
            <CardHeader>
              ...
              <div className='font-style-1-descriptions font-jakarta  text-muted-foreground'>Either sponsoring this event or this post.</div>
            </CardHeader>
              ...
              <Form {...form}>
                ...
                >
                  ...
                  <div className=" space-x-2 flex items-end justify-end ">
                    ...
                    <Button variant="outline" className="font-style-4 font-dmsans  rounded-3xl text-[17px]"
                    onClick={() => {setIsCommentBoxOpen(true); form.reset(); setImageUrl(null);}}
                    >
                      Cancel
                    </Button>

                    <Button type="submit" variant="outline" className="font-style-4 font-dmsans  rounded-3xl text-[17px]"
                    >
                      Post
                    </Button>
                  </div>
       ...
       <div className='mt-[3rem] sm:block hidden col-span-2 sticky overflow-hidden h-fit rounded-md border border-gray-300'>
        ...
        <Card x-chunk="dashboard-01-chunk-5">
            <CardHeader>
              <CardTitle className='font-style-2 font-dmsans '>Created By</CardTitle>
              <div className='font-style-1-subtitle text-muted-foreground'>Moderator/Creator of this event.</div>
            </CardHeader>
            <CardContent className="">
          ...
          <div className="ml-4 space-y-1">
          <p className="text-[14px] font-medium leading-none font-style-5-username font-dmsans ">{userData.name}</p>
            <p className="text-[14px] font-style-5-username font-dmsans  text-muted-foreground">{userData.email}</p>
          </div>
          <div className="ml-auto font-medium"></div>
        </div>
        ...
        <div className='mt-3 sm:block hidden col-span-2 sticky overflow-hidden h-fit rounded-md border border-gray-300'>
          <Card x-chunk="dashboard-01-chunk-5">
              <CardHeader className='text-sm pb-1'>
                <CardTitle className="font-style-2 font-dmsans ">Register</CardTitle>
        ...
        <div className='mt-3 sm:block hidden col-span-2 sticky overflow-hidden h-fit rounded-md border border-gray-300'>
          <Card x-chunk="dashboard-01-chunk-5">
              <CardHeader>
                <CardTitle className='font-style-2 font-dmsans '>Credits</CardTitle>
                <div className='font-style-1-subtitle text-muted-foreground'>Few events comes with Govt. recognized credits. <span className='text-black'>Check Info*</span></div>
              </CardHeader>
        ...
        <Card x-chunk="dashboard-01-chunk-5">
            <CardHeader>
              <CardTitle className='font-style-0 font-jakarta '>Sponsors</CardTitle>
            ...
            <CardContent className="grid gap-8 uppercase">
              ...
              {eventObject.sponsors?(
                eventObject.sponsors.map((sponsor, index)=>{
                  ...
                  <div className="grid gap-1">
                    <p className="font-style-5-username font-dmsans  text-[17px] font-medium leading-none">
                      {sponsor}
                    </p>
                  </div>
                </div>
