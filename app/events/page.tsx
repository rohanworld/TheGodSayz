  ...
  return (
    <>
      ...
      <div>
        ...
        <div className="font-style-1-descriptions font-jakarta  text-base hidden md:block md:mt-[10px] mt-[3px]">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" className={`absolute top-[17px] left-[60.5rem] bg-purple-600 p-3 rounded-full transition-all h-[3rem] w-[3rem] border-transparent text-white hover:cursor-pointer`} fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
      ...
      <div className="lg:container lg:max-w-[98rem] lg:mx-auto font-dmsans mt-[1rem] lg:mt-[85px]">
      <div className="mb-8">
        <div className="font-style-1-subtitle-events font-jakarta font-[700] text-[40px] text-center text-[#0d47a1]">Upcoming Events</div>
        <div className="font-style-1-events font-jakarta lg:text-[46px] text-[37px] font-[700] text-center">Featured Events</div>
      </div>
