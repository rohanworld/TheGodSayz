      ...
      <div className="space-y-4 pt-4 pb-2">
        <div className="px-4 py-2">
          ...
          <div className="space-y-1">
            <Button onClick={()=>{selectChange("all")}} variant={`${currentC=="all"?"secondary":"ghost"}`} className="font-style-4 font-dmsans  w-full justify-start text-[15px]">
              {/* <svg
            ...
            <div>
              {
                ...
                sidebarCategory.map((categoryD:any, index:any)=>(
                  <div key={index}>
                    <Button onClick={()=>{selectChange(categoryD.id)}} variant={`${currentC==categoryD.id.split("|").join("/")?"secondary":"ghost"}`} className="font-style-4 font-dmsans  w-full justify-start text-[15px]">
            ...
            <div className="space-y-1 p-2">
              {playlists?.map((playlist, i) => (
                <Button
                  key={`${playlist}-${i}`}
                  variant="ghost"
                  className="font-style-4 font-dmsans  w-full justify-start text-[15px]"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
