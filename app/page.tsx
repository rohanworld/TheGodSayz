...
export default function Home() {
  ...
  function transformHitToPoll(hit: any) {
    return {
      id: hit.objectID,
      name: hit.name,
      title: hit.title,
  ...
  return (
    ...
    <div className="w-full h-full dark:bg-[#4b3f3f]">
      <div className="md:h-[14.5rem] w-full relative">
        <div className="HomeBanner-heading absolute top-[4rem] left-[34rem] text-white text-[40px] font-semibold">Elevate your Journey</div>
        <div className="HomeBanner-description absolute top-[8rem] left-[428px] text-white text-[20px] font-medium opacity-80">Join a community of seekers and find your path to enlightenment</div>
        <div>
        <div className="absolute top-[12rem] left-[459px] text-white">
          ...
          />
          <svg xmlns="http://www.w3.org/2000/svg" className={`absolute inset-y-0 my-auto ml-[0rem] transition-all h-[59px] w-[53px] border-transparent px-3.5 peer-focus:ml-[0rem] border-[#ffffff] stroke-[#ffffff]`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
