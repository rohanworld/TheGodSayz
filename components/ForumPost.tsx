...
const ForumPost = ({
  ...
  return (
    <>
      {post.uid ? (
        <div className=" bg-[#ffffff] dark:bg-[#262626] my-[10px] mb-3 font-style-6-post font-jakarta">
        ...
        /> */}
            ...
            <div className="w-0 flex-1 break-normal overflow-hidden">
              {!isProfile && (
                <div className="flex max-h-40 mt-1 space-x-2 text-xs">
                  ...
                  <div className=" flex space-x-2">
                    <span className="font-style-5-username font-dmsans  mt-3 text-sm font-semibold dark:text-yellow-50 text-black">
                      {isAnonymous ? (
                        "Anonymous"
                      ) : (
                        <Link
                    ...
                    {isAnonymous || isCurrentUser || !user ? null : (
                      <div className=" flex space-x-1 mr-5 ">
                        ...
                        {
                          <button
                            className="font-style-5-username font-dmsans  mt-[0.33rem] text-[#1976d2] p-0 hover:underline cursor-pointer"
              ...
              <div className={`${post.title ? "" : "hidden"}`}>
                ...
                >
                  <h1
                    className={`font-bold font-style-2 font-dmsans  font-dmsans py-2 leading-6 text-[17px] dark:text-white ${
              ...
              >
                ...
                <p
                  ...
                  className="font-style-3 font-jakarta  dark:text-white text-base/[21px] text-[15px]"
                >
            ...
            <div className=" flex-col space-y-6 items-center justify-center my-auto">
              ...
              >
                <Bookmark
                  className={cn("h-4 w-4 font-style-4 font-dmsans ", {
          ...
          <div className=" rounded-b-md bg-[#e7e7e7] dark:bg-[#1A1A1B]/65 z-20 flex justify-between  gap-x-3 text-sm px-3 py-3  sm:px-6">
            ...
            <Link
              ...
              >
                ...
                <span className="font-style-4 font-dmsans  sm:block hidden">
