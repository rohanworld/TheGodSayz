...
const QuePost = dynamic(() => import('@/components/queAnsPage/QuePost'), {
  ssr: false,
});
const AnsPost = dynamic(() => import('@/components/queAnsPage/AnsPost'), {
  ssr: false,
});
...
const PostContent = ({ postTitle } : { postTitle: string }) => {
  // console.log(postId);
  ...
  return (
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-7 gap-y-4 md:gap-x-4 pb-6 font-dmsans mt-3">
      <div className="bg-section md:col-span-5 col-span-2 order-first">
      ...
      >
                  ...
                  <div className=" space-x-2 flex items-end justify-end ">
                    ...
                    <Button variant="outline" className="font-style-4 font-dmsans  rounded-3xl"
                    onClick={() => {setIsCommentBoxOpen(true); form.reset(); setImageUrl(null);}}
                    >
                      Cancel
                    </Button>

                    <Button type="submit" variant="outline" className="font-style-4 font-dmsans  rounded-3xl "
                    >
                      Post
                    </Button>
                  </div>
      ...
      <div className="bg-section sm:block hidden col-span-2 sticky overflow-hidden h-fit rounded-2xl border border-gray-300 order-last mt-1">
      <div>
        <RecentFeed />
      </div>
