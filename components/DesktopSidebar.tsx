    ...
    <div>
      ...
      >
        <div className="space-y-4 py-4">
          <div className=" py-2">
            <h2 className=" mb-2 px-7 tracking-tight font-style-0 font-jakarta ">
              Categories
            </h2>
            <Command className="dark:bg-[#262626]">
              ...
              <CommandList>
                ...
                <CommandGroup>
                  ...
                  >
                    <CommandItem className="font-[15px] font-style-list font-jakarta">All</CommandItem>
                  </Button>
                </CommandGroup>
                    ...
                    sidebarCategory.map((categoryD: any, index: any) => (
                      <CommandGroup key={index}>
                        <div
                          ...
                          // }`}
                          className="w-full px-4 py-[1px] justify-start font-style-list font-jakarta cursor-pointer"
                        >
                          <CommandItem >
                      ...
                      {/* <AvatarFallback>SP</AvatarFallback> */}
                          ...
                          <div className="text-black dark:text-white font-style-list font-jakarta text-[15px]">{categoryD}</div>
                          </div>
                          </CommandItem>
                          {
      ...
      <div
        className={cn(
          "py-[14px] bt-1 border-black rounded-lg bg-[#ffffff] dark:bg-[#262626] mt-[20px] shadow-[0px_0px_0px_1px_rgba(8,112,184,0.06),0px_1px_1px_-0.5px_rgba(8,112,184,0.06),0px_3px_3px_-1.5px_rgba(8,112,184,0.06),_0px_6px_6px_-3px_rgba(8,112,184,0.06),0px_12px_12px_-6px_rgba(8,112,184,0.06),0px_24px_24px_-12px_rgba(8,112,184,0.06)]",
          className
        )}
      >
        <h2 className="relative px-7 font-bold tracking-tight flex items-center justify-between">
          <h2 className="font-style-0 font-jakarta ">Forums</h2>
          {
              ...
              forums.map((forum: any, index: any) => (
                <div key={index}>
                  ...
                  <div className="h-[20px] w-[20px]">
                    ...
                    <Link href={`/forums/${forum.uniqueForumName}`} className="font-style-list font-jakarta">
                      {forum.title}
                    </Link>
                  </div>
                  {
